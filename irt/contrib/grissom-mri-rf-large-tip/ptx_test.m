...
if ~isvar('B1_final')
    ...
    [Glrg, ms0, mzs0] = Gocrf(k, [FOV FOV], [dim dim], mdom, dt, 'd', d, 'indmask', mask, ...
    ...
    disp 'Running fast large-tip design';
    cgiter = 25;
    db1beta = 0.01;
    ii = 2;
