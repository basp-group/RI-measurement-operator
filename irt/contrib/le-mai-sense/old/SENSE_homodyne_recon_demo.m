...
%%
[demod_recon_im, recon_im, lp_im] = SENSE_homodyne_recon(reduced_ffts, smap, overlap, homodyne_direction, SENSE_direction, regularizer, nc, np, red_dims, figs);
SENSE_only_recon = SENSE_recon(smap, SENSE_only_ffts, SENSE_direction, np, regularizer, figs);
