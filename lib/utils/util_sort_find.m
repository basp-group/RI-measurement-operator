...
% Fast :math:`O(\log_2(N))` computation of the range of indices of `x` that
% satify the upper and lower bound values using the fact that the `x`
% vector is sorted from low to high values. Computation is done via a
% binary search.
%
% Parameters
% ----------
...
% exactLower : int
%     Bool to get values of x greater than LowerBound
% exactUpper : int
%     Bool to get values of x less than UpperBound
%
% Returns
% -------
% lower_index : int
